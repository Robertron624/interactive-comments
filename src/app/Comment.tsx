            ...
            <div className="bg-white rounded-lg w-500 text-grayish-blue p-6">
                ...
                <div className="h-full flex gap-4">
                    ...
                    <div className="h-24 rounded-lg px-1 py-3 flex items-center gap-2 flex-col bg-light-gray">
                        <button onClick={handleUpvote} className="w-6 h-6 font-bold flex justify-center items-center">
                            <svg
                                width="11"
                                height="11"
                        ...
                        <button onClick={handleDownvote} className="w-6 h-6 font-bold flex justify-center items-center">
                            <svg
                                width="11"
                                height="3"
                                xmlns="http://www.w3.org/2000/svg"
